    ...
    <footer className="footer-container">
      ...
      <div className="footer-content">
        <div className="footer-grid">
          ...
          <div className="footer-column info-empresa">
            <img src={LOGO_SRC} alt="Bright Bee School" className="footer-logo" />
            <p className="description">
              Uma escola dedicada ao ensino infantil e fundamental que traz proposta inovadora e pioneira ao estado do Piauí.
            </p>
            <a href="https://www.brightbee.com.br/agende-sua-visita/" className="btn-agendar">Agende sua visita</a>
          </div>

          <div className="footer-column">
            <h3>ENDEREÇO</h3>
            <h3 className="subtitle">Teresina</h3>
            <div className="info-item">
              <i className="fas fa-map-marker-alt"></i>
              <span>R. Anfrisio Lobão, 2024 – São Cristóvão, Teresina/PI – 64051-152</span>
            </div>
            <div className="info-item">
              <i className="fas fa-map-marker-alt"></i>
              <span>R. Desembargador Manoel Castelo Branco, 2039 – São Cristóvão, Teresina/PI</span>
            </div>
            <div className="info-item">
              <i className="fas fa-map-marker-alt"></i>
              <span>R. Anfrisio Lobão, 1794 – São Cristóvão, Teresina/PI – 64049-280</span>
            </div>
            <h3 className="subtitle">Anápolis</h3>
            <div className="info-item">
              <i className="fas fa-map-marker-alt"></i>
              <span>R. Arlindo Costa, 91 – Jundiaí, Anápolis – GO, 75113-200</span>
            </div>
          </div>

          <div className="footer-column hide-mobile">
            <h3>A ESCOLA</h3>
            <a href="https://www.brightbee.com.br/quem-somos/">Quem somos</a>
            <a href="https://www.brightbee.com.br/proposta-pedagogica/">Proposta pedagógica</a>
            <a href="https://www.brightbee.com.br/educacao-infantil/">Educação Infantil</a>
            <a href="https://www.brightbee.com.br/ensino-fundamental/">Ensino Fundamental</a>
            <a href="https://www.brightbee.com.br/ensino-integral/">Ensino Integral</a>
          </div>

          <div className="footer-column hide-mobile">
            <h3>LINKS ÚTEIS</h3>
            <a href="https://www.brightbee.com.br/blog/">Blog</a>
            <a href="https://www.brightbee.com.br/faq/">FAQ</a>
            <a href="https://atracaodetalentos.totvs.app/brightbee/extended">Trabalhe Conosco</a>
            <a href="https://www.brightbee.com.br/contato/">Contato</a>
            <h3 className="title-spacing">TELEFONE</h3>
            <div className="info-item">
              <i className="fas fa-phone"></i>
              <span>(86) 3233-1839</span>
            </div>
          </div>
          ...
          <div className="footer-column">
            ...
            <div className="social-icons">
              <a href="https://www.instagram.com/brightbeeeb/" target="_blank" rel="noopener noreferrer" aria-label="Instagram Bright Bee">
                <i className="fab fa-instagram"></i>
              </a>
              <a href="https://www.youtube.com/channel/UCJh_8utuPtYVE5MvCh3HYAA" target="_blank" rel="noopener noreferrer" aria-label="YouTube Bright Bee">
                <i className="fab fa-youtube"></i>
              </a>
              <a href="https://wa.me/5586994084588" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp Bright Bee">
                <i className="fab fa-whatsapp"></i>
              </a>
            </div>
            <h3 className="title-spacing">TERMOS DE USO</h3>
            <a href="https://www.brightbee.com.br/aviso-de-privacidade/">Política de Privacidade</a>
          </div>
      ...
      <div className="copyright">
        <p>© 2026. Bright Bee. Todos os direitos reservados.</p>
      </div>
    </footer>
  );
}
